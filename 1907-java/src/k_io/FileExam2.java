...
public class FileExam2 extends JFrame {
	...
	private JMenuItem getMntmNewMenuItem() {
		if (mntmNewMenuItem == null) {
			mntmNewMenuItem = new JMenuItem("\uD30C\uC77C\uBCF5\uC0AC");//파일복사
			...
			mntmNewMenuItem_2.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(frame instanceof TextEditor) {
						...
						//새로만들기한경우엔 TextEditor의 fileName이 null
						if(te.fileName == null) {
							JFileChooser fc = new JFileChooser();
							...
							if(flag==JFileChooser.APPROVE_OPTION) {
								...
								te.getStatus().setText("파일 저장을 취소하였습니다.");
								return;
							}
						...
						boolean b =te.save();
						if(b) {
							te.getStatus().setText("파일이 정삭적으로 저장됨");
						}else {
							te.getStatus().setText("오류가 발생함");
						}
	...
	private JMenuItem getMntmNewMenuItem_4() {
		if (mntmNewMenuItem_4 == null) {
			mntmNewMenuItem_4 = new JMenuItem("\uD68C\uC6D0\uC785\uB825");//회원입력
	...
	private JMenuItem getMntmNewMenuItem_5() {
		if (mntmNewMenuItem_5 == null) {
			mntmNewMenuItem_5 = new JMenuItem("\uD68C\uC6D0\uC870\uD68C");//회원조회
	...
	private JMenuItem getMntmNewMenuItem_6() {
		if (mntmNewMenuItem_6 == null) {
			mntmNewMenuItem_6 = new JMenuItem("\uC218\uC815/\uC0AD\uC81C");//수정,삭제
